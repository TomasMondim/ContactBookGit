...
public class Main {
    ...
    public static final String REPEATED_PHONE_MSG = "There are contacts that share phone numbers.";
    ...
    private static void checkRepeatedPhone(ContactBook cBook) {
        if(cBook.hasRepeatedPhone())
            System.out.println(REPEATED_PHONE_MSG);
        else
            System.out.println(NOT_REPEATED_PHONE_MSG);
    }
